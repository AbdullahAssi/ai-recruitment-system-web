  ...
  try {
    ...
    const application = await prisma.application.create({
      data: {
        ...
        jobId,
        status: "PENDING",
        score: 0, // Will be updated by AI scoring
      },
    });
    ...
    return NextResponse.json({
      ...
      matchDetails: {
        ...
        textSimilarity: 0, // Will be calculated by AI
        skillMatchPercentage: 0, // Will be calculated by AI
        matchedSkills: [], // Will be filled by AI
        missingSkills: [], // Will be filled by AI
      },
